...
public class ModEntityTypes {
    ...
    public static final EntityType<TaterMissileEntity> TATER_ROCKET
            = Registry.register(
    ...
    public static void register() {
        FabricDefaultAttributeRegistry.register(TATER_ROCKET, TaterMissileEntity.createMobAttributes());
    }
}
