...
public class TaterRocketModel extends EntityModel<TaterMissileEntity> {
    ...
    public static TexturedModelData getTextureModelData() {
        ...
        ModelPartData fins = modelPartData.addChild("fins", ModelPartBuilder.create(), ModelTransform.pivot(4.6963F, -6.275F, 2.1213F));

        ModelPartData fin1 = fins.addChild("fin1", ModelPartBuilder.create(), ModelTransform.pivot(-4.6963F, 1.275F, -2.1213F));
